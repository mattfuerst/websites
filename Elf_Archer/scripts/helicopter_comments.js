...
var cabin1P = new Path.RegularPolygon(view.center, 3, 20); //triangle
cabin1P.fillColor = 'green';
cabin1P.position.y += 5;
cabin1P.position.x -= 31;
cabin1P.rotate(-90);

var cabin2P = new Path.RegularPolygon(view.center, 4, 24); //rectangle
cabin2P.fillColor = 'green';
cabin2P.position.x += 12;
cabin2P.scale(1.71,1);

var cabin4P = new Path.RegularPolygon(view.center, 50, 16.8); //circle
cabin4P.fillColor = 'green';
cabin4P.position.x += 41;

var cabin = new Group([cabin1P, cabin2P, cabin4P]); //grouping the cabin together

// TOP PROPELLER

var baseRotor = new Path.RegularPolygon(view.center, 3, 10); //triangle
...
var propeller = new Path.RegularPolygon(view.center, 100, 3); //circle
propeller.fillColor = 'black';
propeller.position.y -= 33;
propeller.position.x += 14;
propeller.scale(13,1);

var topPropeller = new Group([propeller, baseRotor]); //group propeller together

//TAIL PROPELLER

var triangleTail = new Path.RegularPolygon(view.center, 3, 15); //traingle
...
var tailPropeller1 = new Path.RegularPolygon(view.center, 100, 2); //circle
tailPropeller1.fillColor = 'black';
tailPropeller1.position.x -= 86;

var tailPropeller2 = new Path.RegularPolygon(view.center, 4, 3); //rectangle
...
var tailPropeller3 = new Path.RegularPolygon(view.center, 4, 3); //rectangle
...
var tailPropeller = new Group([tailPropeller1, tailPropeller2, tailPropeller3]); //group propeller together

var helicopter = new Group([cabin, triangleTail, tailPropeller, topPropeller]); //group all helicopter together
